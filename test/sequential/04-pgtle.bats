...
@test "pgtle: get_version_dir handles versions with suffixes" {
  # Alpha version below threshold
  run call_pgtle_function get_version_dir "1.4.0alpha1"
  assert_success
  [ "$output" = "pg_tle/1.0.0-1.5.0" ]

  # Beta version at threshold
  run call_pgtle_function get_version_dir "1.5.0beta2"
  assert_success
  [ "$output" = "pg_tle/1.5.0+" ]

  # Dev version above threshold
