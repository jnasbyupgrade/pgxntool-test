...
@test "changes can be committed" {
  # Add any new auto-generated versioned SQL files
  # These are generated by make from sql/*.sql and need to be tracked
  ...
  # Commit all changes (modified and newly added)
  run git commit -am "Change META"
  assert_success

  # Verify repo is clean
  local remaining=$(git status --porcelain)
  [ -z "$remaining" ]
}
